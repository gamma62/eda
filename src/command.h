...
TABLE table[] = {
	...
	{ "seall",	KEY_NONE, 3,		PN(select_all),		0x00},
	...
	{ "unindent",	KEY_S_F7, 5,		PN(unindent_left),	0x02},
	{ "indent",	KEY_S_F8, 3,		PN(indent_right),	0x02},
	{ "shleft",	KEY_S_F9, 3,		PN(shift_left),		0x02},
	{ "shright",	KEY_S_F10, 3,		PN(shift_right),	0x02},
	...
	/* special tool to process diff outputs (patches) */
	...
	{ "fmatch",	KEY_C_F9, 2,		PN(forcematch),		0x00},
	{ "fblock",	KEY_C_F10, 2,		PN(fold_block),		0x00},
	{ "thisf",	KEY_C_F11, 4,		PN(fold_thisfunc),	0x00},
	...
	/* resources, keys, macros, projects */
	{ "set",	-1, 3,			PN(set),		0x01},
	...
	/* directory and buffer list, bookmarks, commands list */
	...
	{ "vbn",	KEY_F1, 3,		PN(view_bname),		0x00},
	...
	/* base editor functions -- macro API to hardcoded keys */
...
/* this "db" contains the values and names of recognized (recognizable) button presses,
 * depends on ...libraries, kernel, X
 */
KEYS keys[] = {
